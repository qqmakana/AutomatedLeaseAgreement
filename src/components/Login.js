...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const users = {
      'yehuda': { password: 'yehuda', role: 'Client', name: 'Yehuda' },
      'builder': { password: 'q', role: 'Admin', name: 'Builder' },
      'admin': { password: 'q', role: 'Admin', name: 'Admin' }
    };
        ...
        <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8 transform transition-all duration-300 hover:shadow-3xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Sign in to Automated Lease Drafting System
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              Demo Accounts: <strong>yehuda</strong> (password: yehuda) or <strong>builder</strong> (password: q)
            </p>
          </div>
        </div>
